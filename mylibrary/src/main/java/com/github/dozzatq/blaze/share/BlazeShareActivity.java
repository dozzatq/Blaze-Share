...
public class BlazeShareActivity extends AppCompatActivity {

    private RecyclerView shareView;
    private DefaultItemAnimator itemAnimator;

    private Toolbar toolbar;
    private BlazeShareAdapter blazeShareAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blaze_share);
        ...
        Intent shareIntent = new Intent(getIntent().getStringExtra(BlazeShare.SEND_SHARE_ACTION));
        shareIntent.setType(getIntent().getStringExtra(BlazeShare.SEND_SHARE_TYPE));
        shareIntent.putExtras(shareBundle);
        broadcastReceiver = getIntent().getStringExtra(BlazeShare.SEND_SHARE_PARAM_RECEIVER);

        blazeShareAdapter = new BlazeShareAdapter(this, shareIntent,broadcastReceiver );
